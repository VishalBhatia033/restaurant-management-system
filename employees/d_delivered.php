  ...
  <body>
    <header>
      ...
      <div class="admin_profile">
        <div class="img">
          <img src="admin-icn.png" alt="" style="border-radius:50%;"/>
        </div>
        <p>Employee</p>
      </div>
    </header>
      ...
      <div class="main_content">
        ...
        <div class="movie_container">
          ...
          <?php
              ...
              $sql = "SELECT * FROM orders WHERE orderstatus='picked' AND picked_by='$employee_username' AND cancle_status='0'";
...
<td>" . $row2['item'] . "</td>
<td>" . $name. "</td>
<td><span style='background-color: grey;
color: white;
border-radius: 0.6rem;
padding: 0.1rem 0.3rem;'>" . $address. "</span></td>
...
<td><span class='time_cell'>".$row2['orderstatus'] .
            "</span></td>
<td><form action='d_delivered.php' method='post'>
<input type='hidden' name='orderid' value='".$row2['orderid']."'/>
<input type='hidden' name='username' value='".$row2['username']."'/>
<button type='submit'  class='btn btn-sm btn-primary'  name='delivered'>Delivered
</button></form></td>
...
// <tr>";
  ...
  echo "You have not Picked any Orders";
}
